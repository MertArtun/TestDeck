...
const Layout = ({ children }: LayoutProps) => {
  ...
  const navigation = [
    {
      name: navText.dashboard.name,
      href: '/',
      icon: Home,
      badge: null,
      description: navText.dashboard.desc,
    },
    {
      name: navText.create.name,
      href: '/create',
      icon: Plus,
      badge: null,
      description: navText.create.desc,
    },
    {
      name: navText.study.name,
      href: '/study',
      icon: BookOpen,
      badge: '12',
      description: navText.study.desc,
    },
    {
      name: navText.stats.name,
      href: '/statistics',
      icon: BarChart3,
      badge: null,
      description: navText.stats.desc,
    },
    {
      name: navText.settings.name,
      href: '/settings',
      icon: SettingsIcon,
      badge: null,
      description: navText.settings.desc,
    },
  ];
  ...
  const quickStats = [
    ...
    {
      label: t('layout.quick.streak'),
      value: `7 ${t('common.days')}`,
      icon: Zap,
              ...
              {quickStats.map((stat) => {
                ...
                return (
                  ...
                  >
                    ...
                    <p
                      style={{ fontSize: '14px', fontWeight: 'bold', color: 'white', margin: '0' }}
                    >
                      {stat.value}
                    </p>
                  </div>
